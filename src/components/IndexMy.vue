<template>
    <div class="wrapper">
        <header>
            ...
            <div class="iconfont icon-weidu" @click="loadMessage"></div>
        </header>
        <div class="main" >
            <div class="user">
                <div class="user-img">
            ...
            <div class="list-wrapper">
                <el-collapse v-model="activeName" accordion>
                 ...
                 <mu-raised-button  label="退出登录" class="demo-raised-button" :fullWidth="fullWidth"  primary @click="logOut"/>
            </div>
        </div>
    </div>
</template>
...
<script>
    export default {
        ...
        created() {
            ...
            this.$http({
                url:`https://www.vue-js.com/api/v1/user/${user.loginname}`,
                method:'get'
            }).then((res) => {
               this.fetchData(res)
            }).catch((res) => {
